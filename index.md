...
# Technology-enhanced Assessment & Learning Environments
...
<div class="card-soft">
  <p><strong>{{ site.data.issue.volume }}, {{ site.data.issue.issue }} ({{ site.data.issue.year }})</strong></p>
  <p class="meta">Theme: {{ site.data.issue.theme }}</p>
  <p>{{ site.data.issue.note }}</p>
  <p><a href="{{ '/papers/' | relative_url }}">Browse papers</a></p>
</div>
